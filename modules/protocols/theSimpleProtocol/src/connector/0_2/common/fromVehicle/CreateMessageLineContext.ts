...
import CreateLock from "../../../0_1/pakets/lock/fromVehicle/CreateLock.ts";
import { CreateInterface } from "../../../common/fromVehicle/messageLineContext/CreateInterface.ts";

export class CreateMessageLineContext implements CreateInterface {
  constructor(
...
export default CreateMessageLineContext;
