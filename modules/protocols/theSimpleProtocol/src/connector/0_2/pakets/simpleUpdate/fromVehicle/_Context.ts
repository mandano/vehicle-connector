...
export class Context {
  ...
  private _sanitize: Sanitize | undefined;
  ...
  get buildFromMessageLine(): CreateSimpleUpdate {
    const validate = new Validate(
      this.validationRules,
      this.validationOrder,
      this._logger,
    );
    return new CreateSimpleUpdate(
      validate,
      this.messageLineSplitter,
      this.sanitize,
    );
  }
