  ...
  it(
    ...
    async () => {
      ...
      fakeTcpVehicle.sendMessage(
        `T_S_P;${protocolVersion};${imei};UPDATE_SIMPLE_SCOOTER;2025-05-18T16:16:53.294Z;lat=52.5948795,latOriginatedAt=2025-05-18T16:16:53.294Z,lng=13.6932953,lngOriginatedAt=2025-05-18T16:16:53.294Z`,
      );
